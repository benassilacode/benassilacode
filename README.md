<h1 align="center">
Hi <img src="https://user-images.githubusercontent.com/1303154/88677602-1635ba80-d120-11ea-84d8-d263ba5fc3c0.gif" width="28px" height="28px" alt="hi">, I'm Benassila Reda
</h1>
...
- 💼 Front-End & Full-Stack JavaScript Developer (React / Next.js / Angular / Node.js)
- 🚀 I enjoy building products from scratch and turning ideas into real, scalable applications
- 🧠 Strong focus on clean architecture, reusable components, and maintainable code
- 🔧 Experience with REST APIs, real-time apps, dashboards, and Web3/DApps
- 📚 Continuously learning (testing with Jest, performance, system design)

- :computer: Most used lines of code  
  `console.log("debugging...");` & `border: 1px solid red;`
...
![visitors](https://visitor-badge.glitch.me/badge?page_id=benassilacode.benassilacode)
